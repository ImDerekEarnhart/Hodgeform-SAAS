  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "A tenant-isolated Orbita research lab. Cases, discovery genome, hash-bound experiments, evidence receipts, and governed problem loops.",
      },
